...
ggplot() + 
  ...
  labs(x="Season", y="Penalty yards per game", title="From bad to worse: Nebraska and penalties", subtitle="Nebraska leads the FBS in penalty yards per game in the 2018 season.", caption="Source: cfbstats.com | By Matt Waite") + 
